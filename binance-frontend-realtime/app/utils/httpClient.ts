...
import { Depth, KLine, Tickerdef, Trade } from "./types";

const BASE_URL = "https://exchange-proxy.100xdevs.com/api/v1";

export async function getTicker(market: string): Promise<Tickerdef> {
...
export async function getTickers(): Promise<Tickerdef[]> {
